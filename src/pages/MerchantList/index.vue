<template>
  <div class="wrap">
  <div class="merchant" v-for="(item,index) in merchantList" :key="item.id">
    <div class="content">
      <div class="left">
      ...
      <div class="right">
        ...
        <div class="center" v-if="item.discountsList">
          ...
          <span :class="[num > 2 ? 'up' : 'down','direction']" v-if="item.discountsList.length > 2" @click="showList(index)"><img src="/static/images/down.png" alt=""></span>
        </div>
        <div class="bottom" v-if="item.nearStore">
          <ul class="near">
            <div class="icon-store">
              <span><img src="/static/images/store.png" alt="">附近还有{{item.nearStore.length}}家</span>
              <span :class="[num1 > 1 ? 'up' : 'down','direction']" v-if="item.nearStore.length >= 2" @click="storeList(index)"><img src="/static/images/down.png"></span>
            </div>
